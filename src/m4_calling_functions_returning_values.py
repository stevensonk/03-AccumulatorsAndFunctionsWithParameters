...
def run_test_sum_of_digits():
    ...
    # Test 3:
    expected = 9
    answer = sum_of_digits(63)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 23
    answer = sum_of_digits(5783)
...
def fancy_sums_of_digits(n):
    ...
    x = n ** 1000
    y = n ** 999
    sumx = sum_of_digits(x)
    sumy = sum_of_digits(y)
    return sum_of_digits(sumx ** sumy)
