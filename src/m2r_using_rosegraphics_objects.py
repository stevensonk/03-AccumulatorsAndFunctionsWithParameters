...
#            Draws all functions on that window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When you don't want the window to close immediately, but
#             instead when you click the mouse. Otherwise, the window
#             will close automatically when the program has gone through
#             all of its code.
#
